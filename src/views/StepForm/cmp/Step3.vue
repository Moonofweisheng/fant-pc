<template>
    <el-form :model="form" :rules="rules" ref="step3" label-width="120px" class="example-form">
        ...
        <el-button style="margin-top: 12px;margin-left:120px" type="primary" @click="doSubmit">提交</el-button>
        <el-button style="margin-left:16px" @click="doPreve">上一步</el-button>
    </el-form>
</template>

<script lang='ts' src='./Step3.ts'></script>
